...
exports.handleError = (error, response, body, conv) => {
    ...
    if (!response) {
        ...
        } else if (response.statusCode == 400 && error == null) {
            //Format "Queried parameter's data is not available in the database so emission value is null."
            conv.ask("Sorry, the emissions related information is not available for this country yet. Please try again.");
